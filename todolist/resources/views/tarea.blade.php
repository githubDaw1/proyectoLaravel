      ...
      <table class="table table-responsive table-borderless">
        ...
        <thead>
          <tr class="bg-light">
            ...
            <th scope="col" width="5%">idTar</th>
            <th scope="col" width="20%">titulo</th>
            <th scope="col" width="10%">texto</th>
            <th scope="col" width="20%">fecha</th>
            <th scope="col" width="20%">completa</th>
        ...
        <tbody>
          <tr>
            ...
            <td class="text-end">
              <span class="fw-bolder">$0.99</span> <i class="fa fa-ellipsis-h  ms-2"></i>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>Altroz furry</td>
            <td class="text-end">
              <span class="fw-bolder">$0.19</span> <i class="fa fa-ellipsis-h  ms-2"></i>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="text-end">
              <span class="fw-bolder">$1.99</span> <i class="fa fa-ellipsis-h  ms-2"></i>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="text-end">
              <span class="fw-bolder">$9.99</span> <i class="fa fa-ellipsis-h  ms-2"></i>
            </td>
          </tr>
